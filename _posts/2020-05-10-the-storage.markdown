...
[![Склад]({{'/assets/the-storage/overview.png' | relative_url}})]({{'/assets/the-storage/overview.png' | relative_url}})
...
[![Страница]({{'/assets/the-storage/page.png' | relative_url}})]({{'/assets/the-storage/page.png' | relative_url}})
...
[![Всё]({{'/assets/the-storage/all-view.png' | relative_url}})]({{'/assets/the-storage/all-view.png' | relative_url}})
...
[![Бэклог]({{'/assets/the-storage/backlog-view.png' | relative_url}})]({{'/assets/the-storage/backlog-view.png' | relative_url}})
...
[![Книги]({{'/assets/the-storage/books-view.png' | relative_url}})]({{'/assets/the-storage/books-view.png' | relative_url}})

**Курсы**

Выглядит и работает так же, как доска с книгами. Удобно открывать карточки с конспектами из колонки начатых.

[![Курсы]({{'/assets/the-storage/courses-view.png' | relative_url}})]({{'/assets/the-storage/courses-view.png' | relative_url}})

**Лекции**

Простой список с лекциями. Внутри конспекты. Отображается название, о чём и дата.

[![Лекции]({{'/assets/the-storage/lectures-view.png' | relative_url}})]({{'/assets/the-storage/lectures-view.png' | relative_url}})

**Начато**

Таблица с тем, что начал смотреть. Тут всё, кроме книг и курсов.

[![Начато]({{'/assets/the-storage/started-view.png' | relative_url}})]({{'/assets/the-storage/started-view.png' | relative_url}})
...
[![История]({{'/assets/the-storage/history-view.png' | relative_url}})]({{'/assets/the-storage/history-view.png' | relative_url}})
